  ...
  return (
    ...
    {logged&&access.type==2?<>
        ...
        <div className='helplinea'>
          ...
          <div style={{padding:"0.5rem 0 "}}><BiIcons.BiLocationPlus size={30} style={{paddingRight:"2%"}}/><span style={{fontFamily:'roboto',fontSize:"1.1rem"}}>Prof. Snehal Awate, #208, SJMSOM building, IIT Bombay, Powai Mumbai 400076
</span></div>
